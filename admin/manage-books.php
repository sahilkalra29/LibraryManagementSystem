                ...
                <div class="panel panel-default">
                    ...
                    <div class="panel-body">
                        <div class="table-responsive">
                            ...
                            <tbody>
<?php $sql = "SELECT tblbooks.BookName,tblcategory.CategoryName,tblauthors.AuthorName,tblbooks.ISBNNumber,tblbooks.BookQuantity,tblbooks.IssuedQuantity,tblbooks.id as bookid from  tblbooks join tblcategory on tblcategory.id=tblbooks.CatId join tblauthors on tblauthors.id=tblbooks.AuthorId";
$query = $dbh -> prepare($sql);
$query->execute();
                        ...
                        if($query->rowCount() > 0)
                        {
                            ...
                            {               ?>                                      
                                <tr class="odd gradeX">
                                    ...
                                    <td class="center"><?php echo htmlentities($result->IssuedQuantity);?></td>
                                    <td class="center">
