...
if(isset($_POST['update']))
{
    ...
    $sql="update  tblbooks set BookName=:bookname,CatId=:category,AuthorId=:author,ISBNNumber=:isbn,BookQuantity=:bookquantity where id=:bookid";
            ...
            <div class="col-md-6 col-sm-6 col-xs-12 col-md-offset-3"">
                <div class="panel panel-info">
                    ...
                    <div class="panel-body">
                        ...
                        <div class="form-group">
                            <label>Total Book Quantity<span style="color:red;">*</span></label>
                            <input class="form-control" type="text" name="bookquantity" value="<?php echo htmlentities($result->BookQuantity);?>"   required="required" />
                        </div>
                        <?php }} ?>
